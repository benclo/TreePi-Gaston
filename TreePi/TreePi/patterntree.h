...
class PatternTree {
  public:
    PatternTree ( Path &path, unsigned int legindex, unordered_map<Graph, int, GraphHasher>& trees);
    ~PatternTree ();
    void expand (unordered_map<Graph, int, GraphHasher>& trees);
  private:
    ...
    PatternTree ( PatternTree &parenttree, unsigned int legindex, unordered_map<Graph, int, GraphHasher>& trees);
